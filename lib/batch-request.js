...
var batchRequest = function (params) {
    ...
    params.targetData = params.targetData || void 0;
    ...
    var batch = function (req, res, next) {
        ...
        var requests = params.targetData || req.body;
        ...
        var requestPromise = function (r) {
            ...
            return request(r)
                ...
                .catch(function (err) {
                    return {
                        statusCode: err.statusCode || err.error.code,
                        body: err.response && err.response.body || {message: err.error.message},
    ...
    batch.validate = function (req, res, next) {
        var err = null,
            requests = params.targetData || req.body,
            requestHost;
